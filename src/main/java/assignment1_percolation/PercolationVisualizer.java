 ...
 *  Execution:    java assignment1_percolation.PercolationVisualizer input.txt
 *  Dependencies: assignment1_percolation.Percolation.java
 *
 *  This program takes the name of a file as a command-line argument.
 *  From that file, it
 *
 *    - Reads the grid size n of the assignment1_percolation system.
...
public class PercolationVisualizer {
    ...
    // draw n-by-n assignment1_percolation system
    ...
    public static void main(String[] args) {
        ...
        int n = in.readInt();         // n-by-n assignment1_percolation system
