...
//        else if (alg.equals("Bubble"))          Bubble.sort(a);
        ...
        else if (alg.equals("MergeCreateArray"))         MergeCreateArray.sort(a);
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 0) {
            ...
            System.out.println("Please type 'alg1 alg2 n trials, example:");
            System.out.println("Shell Selection 1000 100");
            alg1 = StdIn.readString();
            alg2 = StdIn.readString();
            n = StdIn.readInt();
